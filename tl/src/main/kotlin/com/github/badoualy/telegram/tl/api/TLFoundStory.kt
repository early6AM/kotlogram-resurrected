 ...
 */
class TLFoundStory() : TLObject() {
    var peer: TLAbsPeer = TLPeerChat()

    var story: TLAbsStoryItem = TLStoryItemDeleted()

    private val _constructor: String = "foundStory#e87acbc0"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLFoundStory) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xe87acbc0.toInt()
    }
}
