 ...
 */
class TLBusinessRecipients() : TLObject() {
    @Transient
    ...
    private val _constructor: String = "businessRecipients#21108ff7"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLBusinessRecipients) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x21108ff7.toInt()
    }
}
