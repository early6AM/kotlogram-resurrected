 ...
 */
class TLRequestChatlistsHideChatlistUpdates() : TLMethod<TLBool>() {
    var chatlist: TLInputChatlistDialogFilter = TLInputChatlistDialogFilter()

    private val _constructor: String = "chatlists.hideChatlistUpdates#66e486fb"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestChatlistsHideChatlistUpdates) return false
        if (other === this) return true

        return chatlist == other.chatlist
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x66e486fb.toInt()
    }
}
