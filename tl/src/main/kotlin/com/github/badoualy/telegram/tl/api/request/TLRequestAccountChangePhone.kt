 ...
 */
class TLRequestAccountChangePhone() : TLMethod<TLAbsUser>() {
    ...
    private val _constructor: String = "account.changePhone#70c32edb"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestAccountChangePhone) return false
