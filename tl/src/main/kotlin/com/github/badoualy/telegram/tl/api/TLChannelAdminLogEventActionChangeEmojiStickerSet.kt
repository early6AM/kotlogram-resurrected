 ...
 */
class TLChannelAdminLogEventActionChangeEmojiStickerSet() : TLAbsChannelAdminLogEventAction() {
    ...
    private val _constructor: String = "channelAdminLogEventActionChangeEmojiStickerSet#46d840ab"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLChannelAdminLogEventActionChangeEmojiStickerSet) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x46d840ab.toInt()
    }
}
