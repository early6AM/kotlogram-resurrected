 ...
 */
class TLRequestBotsSetBotGroupDefaultAdminRights() : TLMethod<TLBool>() {
    var adminRights: TLChatAdminRights = TLChatAdminRights()

    private val _constructor: String = "bots.setBotGroupDefaultAdminRights#925ec9ea"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestBotsSetBotGroupDefaultAdminRights) return false
        if (other === this) return true

        return adminRights == other.adminRights
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x925ec9ea.toInt()
    }
}
