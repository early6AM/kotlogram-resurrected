 ...
 */
class TLEmojiGroupGreeting() : TLAbsEmojiGroup() {
    ...
    private val _constructor: String = "emojiGroupGreeting#80d26cc7"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLEmojiGroupGreeting) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x80d26cc7.toInt()
    }
}
