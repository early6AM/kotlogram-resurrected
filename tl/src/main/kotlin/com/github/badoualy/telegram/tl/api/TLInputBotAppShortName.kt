 ...
 */
class TLInputBotAppShortName() : TLAbsInputBotApp() {
    var botId: TLAbsInputUser = TLInputUserEmpty()

    var shortName: String = ""

    private val _constructor: String = "inputBotAppShortName#908c0407"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLInputBotAppShortName) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x908c0407.toInt()
    }
}
