 ...
 */
class TLSecureValueErrorFile() : TLAbsSecureValueError() {
    ...
    private val _constructor: String = "secureValueErrorFile#7a700873"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLSecureValueErrorFile) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x7a700873.toInt()
    }
}
