 ...
 */
class TLChatlistUpdates() : TLObject() {
    ...
    private val _constructor: String = "chatlists.chatlistUpdates#93bd878d"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLChatlistUpdates) return false
        if (other === this) return true

        return missingPeers == other.missingPeers
                && chats == other.chats
                && users == other.users
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x93bd878d.toInt()
    }
}
