 ...
 */
class TLRequestChatlistsLeaveChatlist() : TLMethod<TLAbsUpdates>() {
    ...
    private val _constructor: String = "chatlists.leaveChatlist#74fae13a"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestChatlistsLeaveChatlist) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x74fae13a.toInt()
    }
}
