 ...
 */
class TLInactiveChats() : TLObject() {
    ...
    private val _constructor: String = "messages.inactiveChats#a927fec5"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLInactiveChats) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xa927fec5.toInt()
    }
}
