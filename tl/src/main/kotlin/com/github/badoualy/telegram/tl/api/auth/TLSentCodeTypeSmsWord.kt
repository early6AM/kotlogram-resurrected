 ...
 */
class TLSentCodeTypeSmsWord() : TLAbsSentCodeType() {
    var beginning: String? = null

    private val _constructor: String = "auth.sentCodeTypeSmsWord#a416ac81"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLSentCodeTypeSmsWord) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xa416ac81.toInt()
    }
}
