 ...
 */
class TLRequestMessagesSearchSentMedia() : TLMethod<TLAbsMessages>() {
    var q: String = ""
    ...
    private val _constructor: String = "messages.searchSentMedia#107e31a0"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesSearchSentMedia) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x107e31a0.toInt()
    }
}
