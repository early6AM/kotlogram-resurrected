 ...
 */
class TLRequestMessagesReportEncryptedSpam() : TLMethod<TLBool>() {
    var peer: TLInputEncryptedChat = TLInputEncryptedChat()

    private val _constructor: String = "messages.reportEncryptedSpam#4b0c8c0f"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(peer: TLInputEncryptedChat) : this() {
        this.peer = peer
    }
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesReportEncryptedSpam) return false
