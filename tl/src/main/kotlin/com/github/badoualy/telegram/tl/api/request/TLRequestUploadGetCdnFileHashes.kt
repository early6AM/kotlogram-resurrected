...
class TLRequestUploadGetCdnFileHashes() : TLMethod<TLObjectVector<TLFileHash>>() {
    ...
    private val _constructor: String = "upload.getCdnFileHashes#91dc3f31"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(fileToken: TLBytes, offset: Long) : this() {
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x91dc3f31.toInt()
    }
}
