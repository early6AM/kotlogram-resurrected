...
class TLSecureValue() : TLObject() {
    ...
    var translation: TLObjectVector<TLAbsSecureFile>? = TLObjectVector()
    ...
    private val _constructor: String = "secureValue#187fa0ca"
    ...
    constructor(
            ...
            translation: TLObjectVector<TLAbsSecureFile>?,
