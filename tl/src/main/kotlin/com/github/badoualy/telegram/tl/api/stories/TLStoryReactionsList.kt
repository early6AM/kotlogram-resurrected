 ...
 */
class TLStoryReactionsList() : TLObject() {
    var count: Int = 0

    var reactions: TLObjectVector<TLAbsStoryReaction> = TLObjectVector()
    ...
    private val _constructor: String = "stories.storyReactionsList#aa5f789c"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(
            count: Int,
            reactions: TLObjectVector<TLAbsStoryReaction>,
    ...
    override fun deserializeBody(tlDeserializer: TLDeserializer) = with (tlDeserializer)  {
        _flags = readInt()
        count = readInt()
        reactions = readTLVector<TLAbsStoryReaction>()
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLStoryReactionsList) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xaa5f789c.toInt()
    }
}
