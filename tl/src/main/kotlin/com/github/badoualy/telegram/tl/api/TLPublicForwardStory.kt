 ...
 */
class TLPublicForwardStory() : TLAbsPublicForward() {
    var peer: TLAbsPeer = TLPeerChat()

    var story: TLAbsStoryItem = TLStoryItemDeleted()

    private val _constructor: String = "publicForwardStory#edf3add0"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLPublicForwardStory) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xedf3add0.toInt()
    }
}
