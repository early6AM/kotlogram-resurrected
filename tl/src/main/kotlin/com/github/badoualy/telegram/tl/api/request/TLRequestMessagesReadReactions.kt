 ...
 */
class TLRequestMessagesReadReactions() : TLMethod<TLAffectedHistory>() {
    var peer: TLAbsInputPeer = TLInputPeerEmpty()

    var topMsgId: Int? = null

    private val _constructor: String = "messages.readReactions#54aa7f8e"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesReadReactions) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x54aa7f8e.toInt()
    }
}
