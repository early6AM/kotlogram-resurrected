 ...
 */
class TLUpdateStarsRevenueStatus() : TLAbsUpdate() {
    var peer: TLAbsPeer = TLPeerChat()

    var status: TLStarsRevenueStatus = TLStarsRevenueStatus()

    private val _constructor: String = "updateStarsRevenueStatus#a584b019"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(peer: TLAbsPeer, status: TLStarsRevenueStatus) : this() {
        this.peer = peer
        this.status = status
    }
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLUpdateStarsRevenueStatus) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xa584b019.toInt()
    }
}
