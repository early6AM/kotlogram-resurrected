 ...
 */
class TLRequestAccountUpdateBirthday() : TLMethod<TLBool>() {
    var birthday: TLBirthday? = null

    private val _constructor: String = "account.updateBirthday#cc6e0c11"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(birthday: TLBirthday?) : this() {
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestAccountUpdateBirthday) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xcc6e0c11.toInt()
    }
}
