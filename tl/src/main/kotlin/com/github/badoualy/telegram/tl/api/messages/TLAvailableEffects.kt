 ...
 */
class TLAvailableEffects() : TLAbsAvailableEffects() {
    var hash: Int = 0

    var effects: TLObjectVector<TLAvailableEffect> = TLObjectVector()

    var documents: TLObjectVector<TLAbsDocument> = TLObjectVector()

    private val _constructor: String = "messages.availableEffects#bddb616e"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(
            hash: Int,
            effects: TLObjectVector<TLAvailableEffect>,
    ...
    override fun deserializeBody(tlDeserializer: TLDeserializer) = with (tlDeserializer)  {
        hash = readInt()
        effects = readTLVector<TLAvailableEffect>()
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLAvailableEffects) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xbddb616e.toInt()
    }
}
