 ...
 */
class TLUpdateEditChannelMessage() : TLAbsUpdate() {
    ...
    private val _constructor: String = "updateEditChannelMessage#1b3f4df7"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLUpdateEditChannelMessage) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x1b3f4df7
    }
}
