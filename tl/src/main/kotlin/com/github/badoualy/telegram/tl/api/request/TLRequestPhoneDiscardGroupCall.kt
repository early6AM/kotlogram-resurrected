 ...
 */
class TLRequestPhoneDiscardGroupCall() : TLMethod<TLAbsUpdates>() {
    var call: TLInputGroupCall = TLInputGroupCall()

    private val _constructor: String = "phone.discardGroupCall#7a777135"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestPhoneDiscardGroupCall) return false
        if (other === this) return true

        return call == other.call
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x7a777135.toInt()
    }
}
