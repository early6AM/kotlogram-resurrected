 ...
 */
class TLSavedDialogs() : TLAbsSavedDialogs() {
    ...
    private val _constructor: String = "messages.savedDialogs#f83ae221"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLSavedDialogs) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xf83ae221.toInt()
    }
}
