 ...
 */
class TLRequestMessagesToggleSavedDialogPin() : TLMethod<TLBool>() {
    @Transient
    var pinned: Boolean = false

    var peer: TLAbsInputDialogPeer = TLInputDialogPeer()

    private val _constructor: String = "messages.toggleSavedDialogPin#ac81bbde"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesToggleSavedDialogPin) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xac81bbde.toInt()
    }
}
