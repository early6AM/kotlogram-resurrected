 ...
 */
class TLRequestChannelsSetEmojiStickers() : TLMethod<TLBool>() {
    var channel: TLAbsInputChannel = TLInputChannelEmpty()

    var stickerset: TLAbsInputStickerSet = TLInputStickerSetEmpty()

    private val _constructor: String = "channels.setEmojiStickers#3cd930b7"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestChannelsSetEmojiStickers) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x3cd930b7.toInt()
    }
}
