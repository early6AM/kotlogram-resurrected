 ...
 */
class TLBotInlineMessageMediaContact() : TLAbsBotInlineMessage() {
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLBotInlineMessageMediaContact) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x18d1cdc2
    }
}
