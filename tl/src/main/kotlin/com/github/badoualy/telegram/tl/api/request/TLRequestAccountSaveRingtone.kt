 ...
 */
class TLRequestAccountSaveRingtone() : TLMethod<TLAbsSavedRingtone>() {
    var id: TLAbsInputDocument = TLInputDocumentEmpty()

    var unsave: Boolean = false

    private val _constructor: String = "account.saveRingtone#3dea5b03"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestAccountSaveRingtone) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x3dea5b03.toInt()
    }
}
