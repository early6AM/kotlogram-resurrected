 ...
 */
class TLUpdateBotNewBusinessMessage() : TLAbsUpdate() {
    ...
    private val _constructor: String = "updateBotNewBusinessMessage#9ddb347c"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLUpdateBotNewBusinessMessage) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x9ddb347c.toInt()
    }
}
