 ...
 */
class TLInputPrivacyValueAllowUsers() : TLAbsInputPrivacyRule() {
    var users: TLObjectVector<TLAbsInputUser> = TLObjectVector()

    private val _constructor: String = "inputPrivacyValueAllowUsers#131cc67f"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLInputPrivacyValueAllowUsers) return false
