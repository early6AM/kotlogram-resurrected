 ...
 */
class TLRequestStickersDeleteStickerSet() : TLMethod<TLBool>() {
    var stickerset: TLAbsInputStickerSet = TLInputStickerSetEmpty()

    private val _constructor: String = "stickers.deleteStickerSet#87704394"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestStickersDeleteStickerSet) return false
        if (other === this) return true

        return stickerset == other.stickerset
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x87704394.toInt()
    }
}
