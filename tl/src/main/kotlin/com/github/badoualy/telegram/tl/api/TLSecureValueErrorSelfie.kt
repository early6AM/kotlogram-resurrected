 ...
 */
class TLSecureValueErrorSelfie() : TLAbsSecureValueError() {
    ...
    private val _constructor: String = "secureValueErrorSelfie#e537ced6"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLSecureValueErrorSelfie) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xe537ced6.toInt()
    }
}
