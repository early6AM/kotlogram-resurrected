 ...
 */
class TLRequestStoriesGetPinnedStories() : TLMethod<TLStories>() {
    ...
    private val _constructor: String = "stories.getPinnedStories#5821a5dc"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestStoriesGetPinnedStories) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x5821a5dc.toInt()
    }
}
