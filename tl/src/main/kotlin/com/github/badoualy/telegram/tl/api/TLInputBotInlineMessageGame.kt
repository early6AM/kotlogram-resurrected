 ...
 */
class TLInputBotInlineMessageGame() : TLAbsInputBotInlineMessage() {
    override var replyMarkup: TLAbsReplyMarkup? = null

    private val _constructor: String = "inputBotInlineMessageGame#4b425864"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(replyMarkup: TLAbsReplyMarkup?) : this() {
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLInputBotInlineMessageGame) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x4b425864.toInt()
    }
}
