 ...
 */
class TLRequestMessagesUpdateSavedReactionTag() : TLMethod<TLBool>() {
    var reaction: TLAbsReaction = TLReactionEmpty()

    var title: String? = null

    private val _constructor: String = "messages.updateSavedReactionTag#60297dec"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(reaction: TLAbsReaction, title: String?) : this() {
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesUpdateSavedReactionTag) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x60297dec.toInt()
    }
}
