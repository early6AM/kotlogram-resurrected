 ...
 */
class TLInputBusinessBotRecipients() : TLObject() {
    @Transient
    ...
    var excludeUsers: TLObjectVector<TLAbsInputUser>? = TLObjectVector()

    private val _constructor: String = "inputBusinessBotRecipients#c4e5921e"
    ...
    constructor(
            ...
            excludeUsers: TLObjectVector<TLAbsInputUser>?
    ) : this() {
    ...
    override fun deserializeBody(tlDeserializer: TLDeserializer) = with (tlDeserializer)  {
        ...
        users = readIfMask(1, 16) { readTLVector<TLAbsInputUser>() }
        excludeUsers = readIfMask(1, 64) { readTLVector<TLAbsInputUser>() }
    }
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLInputBusinessBotRecipients) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xc4e5921e.toInt()
    }
}
