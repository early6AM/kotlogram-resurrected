 ...
 */
class TLRequestMessagesSearchEmojiStickerSets() : TLMethod<TLAbsFoundStickerSets>() {
    @Transient
    ...
    private val _constructor: String = "messages.searchEmojiStickerSets#92b4494c"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesSearchEmojiStickerSets) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x92b4494c.toInt()
    }
}
