 ...
 */
class TLRequestBotsInvokeWebViewCustomMethod() : TLMethod<TLDataJSON>() {
    ...
    private val _constructor: String = "bots.invokeWebViewCustomMethod#87fc5e7"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestBotsInvokeWebViewCustomMethod) return false
        if (other === this) return true

        return bot == other.bot
                && customMethod == other.customMethod
                && params == other.params
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x87fc5e7.toInt()
    }
}
