 ...
 */
class TLRequestChatlistsGetExportedInvites() : TLMethod<TLExportedInvites>() {
    var chatlist: TLInputChatlistDialogFilter = TLInputChatlistDialogFilter()

    private val _constructor: String = "chatlists.getExportedInvites#ce03da83"
    ...
    override fun deserializeResponse_(tlDeserializer: TLDeserializer): TLExportedInvites = tlDeserializer.readTLObject(TLExportedInvites::class, TLExportedInvites.CONSTRUCTOR_ID)
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestChatlistsGetExportedInvites) return false
        if (other === this) return true

        return chatlist == other.chatlist
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xce03da83.toInt()
    }
}
