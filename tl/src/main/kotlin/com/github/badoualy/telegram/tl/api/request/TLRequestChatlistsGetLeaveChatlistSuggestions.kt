 ...
 */
class TLRequestChatlistsGetLeaveChatlistSuggestions() : TLMethod<TLObjectVector<TLAbsPeer>>() {
    var chatlist: TLInputChatlistDialogFilter = TLInputChatlistDialogFilter()

    private val _constructor: String = "chatlists.getLeaveChatlistSuggestions#fdbcd714"
    ...
    override fun deserializeResponse_(tlDeserializer: TLDeserializer): TLObjectVector<TLAbsPeer> = tlDeserializer.readTLVector<TLAbsPeer>()
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestChatlistsGetLeaveChatlistSuggestions) return false
        if (other === this) return true

        return chatlist == other.chatlist
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xfdbcd714.toInt()
    }
}
