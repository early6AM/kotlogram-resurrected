 ...
 */
class TLSecureValueErrorFrontSide() : TLAbsSecureValueError() {
    ...
    private val _constructor: String = "secureValueErrorFrontSide#be3dfa"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLSecureValueErrorFrontSide) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xbe3dfa.toInt()
    }
}
