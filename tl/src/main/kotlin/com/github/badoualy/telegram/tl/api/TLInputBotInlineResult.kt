...
class TLInputBotInlineResult() : TLAbsInputBotInlineResult() {
    ...
    override fun deserializeBody(tlDeserializer: TLDeserializer) = with (tlDeserializer)  {
        ...
        thumb = readIfMask(1, 16) { readTLObject<TLInputWebDocument>(TLInputWebDocument::class, TLInputWebDocument.CONSTRUCTOR_ID) }
        content = readIfMask(1, 32) { readTLObject<TLInputWebDocument>(TLInputWebDocument::class, TLInputWebDocument.CONSTRUCTOR_ID) }
