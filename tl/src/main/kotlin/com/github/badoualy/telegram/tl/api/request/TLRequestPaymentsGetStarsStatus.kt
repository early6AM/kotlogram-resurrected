 ...
 */
class TLRequestPaymentsGetStarsStatus() : TLMethod<TLStarsStatus>() {
    var peer: TLAbsInputPeer = TLInputPeerEmpty()

    private val _constructor: String = "payments.getStarsStatus#104fcfa7"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestPaymentsGetStarsStatus) return false
        if (other === this) return true

        return peer == other.peer
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x104fcfa7.toInt()
    }
}
