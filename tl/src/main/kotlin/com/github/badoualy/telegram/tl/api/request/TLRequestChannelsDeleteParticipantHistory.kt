 ...
 */
class TLRequestChannelsDeleteParticipantHistory() : TLMethod<TLAffectedHistory>() {
    var channel: TLAbsInputChannel = TLInputChannelEmpty()

    var participant: TLAbsInputPeer = TLInputPeerEmpty()

    private val _constructor: String = "channels.deleteParticipantHistory#367544db"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestChannelsDeleteParticipantHistory) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x367544db.toInt()
    }
}
