 ...
 */
class TLSentCodeTypeSmsPhrase() : TLAbsSentCodeType() {
    var beginning: String? = null

    private val _constructor: String = "auth.sentCodeTypeSmsPhrase#b37794af"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(beginning: String?) : this() {
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLSentCodeTypeSmsPhrase) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xb37794af.toInt()
    }
}
