 ...
 */
class TLSentCodeSuccess() : TLAbsSentCode() {
    var authorization: TLAbsAuthorization = TLAuthorizationSignUpRequired()

    private val _constructor: String = "auth.sentCodeSuccess#2390fe44"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLSentCodeSuccess) return false
        if (other === this) return true

        return authorization == other.authorization
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x2390fe44.toInt()
    }
}
