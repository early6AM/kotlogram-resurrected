 ...
 */
class TLRequestStoriesGetStoriesByID() : TLMethod<TLStories>() {
    var peer: TLAbsInputPeer = TLInputPeerEmpty()

    var id: TLIntVector = TLIntVector()

    private val _constructor: String = "stories.getStoriesByID#5774ca74"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestStoriesGetStoriesByID) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x5774ca74.toInt()
    }
}
