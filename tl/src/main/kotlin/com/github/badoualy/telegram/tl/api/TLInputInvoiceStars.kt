 ...
 */
class TLInputInvoiceStars() : TLAbsInputInvoice() {
    var purpose: TLAbsInputStorePaymentPurpose = TLInputStorePaymentPremiumSubscription()

    private val _constructor: String = "inputInvoiceStars#65f00ce3"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLInputInvoiceStars) return false
        if (other === this) return true

        return purpose == other.purpose
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x65f00ce3.toInt()
    }
}
