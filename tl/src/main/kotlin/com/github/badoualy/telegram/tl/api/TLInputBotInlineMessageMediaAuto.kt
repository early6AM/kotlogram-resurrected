 ...
 */
class TLInputBotInlineMessageMediaAuto() : TLAbsInputBotInlineMessage() {
    @Transient
    ...
    private val _constructor: String = "inputBotInlineMessageMediaAuto#3380c786"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLInputBotInlineMessageMediaAuto) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x3380c786.toInt()
    }
}
