 ...
 */
class TLRequestMessagesSetDefaultReaction() : TLMethod<TLBool>() {
    var reaction: TLAbsReaction = TLReactionEmpty()

    private val _constructor: String = "messages.setDefaultReaction#4f47a016"

    override val constructorId: Int = CONSTRUCTOR_ID

    constructor(reaction: TLAbsReaction) : this() {
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesSetDefaultReaction) return false
        if (other === this) return true

        return reaction == other.reaction
    }
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x4f47a016.toInt()
    }
}
