 ...
 */
class TLRequestMessagesGetSavedDialogs() : TLMethod<TLAbsSavedDialogs>() {
    @Transient
    ...
    private val _constructor: String = "messages.getSavedDialogs#5381d21a"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesGetSavedDialogs) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x5381d21a.toInt()
    }
}
