 ...
 */
class TLInputStickeredMediaPhoto() : TLAbsInputStickeredMedia() {
    var id: TLAbsInputPhoto = TLInputPhotoEmpty()

    private val _constructor: String = "inputStickeredMediaPhoto#4a992157"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLInputStickeredMediaPhoto) return false
