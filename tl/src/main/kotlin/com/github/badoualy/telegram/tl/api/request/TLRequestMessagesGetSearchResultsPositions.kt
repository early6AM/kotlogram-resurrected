 ...
 */
class TLRequestMessagesGetSearchResultsPositions() : TLMethod<TLSearchResultsPositions>() {
    ...
    private val _constructor: String = "messages.getSearchResultsPositions#9c7f2f10"
    ...
    override fun deserializeResponse_(tlDeserializer: TLDeserializer): TLSearchResultsPositions = tlDeserializer.readTLObject(TLSearchResultsPositions::class, TLSearchResultsPositions.CONSTRUCTOR_ID)
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLRequestMessagesGetSearchResultsPositions) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x9c7f2f10.toInt()
    }
}
