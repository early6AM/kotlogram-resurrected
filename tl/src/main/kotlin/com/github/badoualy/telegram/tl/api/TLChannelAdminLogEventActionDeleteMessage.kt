 ...
 */
class TLChannelAdminLogEventActionDeleteMessage() : TLAbsChannelAdminLogEventAction() {
    var message: TLAbsMessage = TLMessageEmpty()

    private val _constructor: String = "channelAdminLogEventActionDeleteMessage#42e047bb"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLChannelAdminLogEventActionDeleteMessage) return false
