 ...
 */
class TLResolvedBusinessChatLinks() : TLObject() {
    ...
    private val _constructor: String = "account.resolvedBusinessChatLinks#9a23af21"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLResolvedBusinessChatLinks) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0x9a23af21.toInt()
    }
}
