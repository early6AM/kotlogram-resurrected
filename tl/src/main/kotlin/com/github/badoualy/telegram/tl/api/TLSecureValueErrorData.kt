 ...
 */
class TLSecureValueErrorData() : TLAbsSecureValueError() {
    ...
    private val _constructor: String = "secureValueErrorData#e8a40bd9"
    ...
    override fun equals(other: Any?): Boolean {
        if (other !is TLSecureValueErrorData) return false
    ...
    companion object  {
        const val CONSTRUCTOR_ID: Int = 0xe8a40bd9.toInt()
    }
}
